                        ...
                        >
                            <Dialog.Panel className="w-full max-w-[95vw] transform overflow-hidden rounded-2xl bg-white shadow-2xl transition-all h-[90vh] flex flex-col">
                                        ...
                                        <form id="ficha-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                            {step === 2 && (
                                                <div className="space-y-4">
                                                    ...
                                                    {/* Main Accordion 2: Recetario y Plan de Tratamiento */}
                                                    <div className={`rounded-xl border-2 transition-all ${mainAccordion === 2 ? 'border-teal-500 bg-teal-50/5' : 'border-slate-200 bg-white'}`}>
                                                        <button
                                                            type="button"
                                                            onClick={() => {
                                                                const newState = mainAccordion === 2 ? null : 2;
                                                                setMainAccordion(newState);
                                                                if (newState === 2) {
                                                                    setTimeout(() => {
                                                                        const el = document.getElementById('accordion-2');
                                                                        if (el) el.scrollIntoView({ behavior: 'smooth', block: 'start' });
                                                                    }, 100);
                                                                }
                                                            }}
                                                        ...
                                                        >
                                                            <div className="flex items-center gap-3">
                                                                <BeakerIcon className={`h-6 w-6 ${mainAccordion === 2 ? 'text-teal-600' : 'text-slate-400'}`} />
                                                                <span className="text-sm font-black uppercase text-slate-700">2. PLAN DE TRATAMIENTO Y PRESUPUESTO</span>
                                                            </div>
                                                            <ChevronUpIcon className={`h-5 w-5 text-slate-400 transition-transform ${mainAccordion === 2 ? 'rotate-180' : ''}`} />
                                                        </button>
                                                            ...
                                                            <div className="p-6 space-y-6">
                                                                <div className="bg-teal-50 border border-teal-200 p-4 rounded-xl flex items-center gap-4">
                                                                    <div className="p-2 bg-teal-100 rounded-lg">
                                                                        <CalculatorIcon className="h-6 w-6 text-teal-600" />
                                                                    </div>
                                                                    <div>
                                                                        <h5 className="text-xs font-bold text-teal-900 uppercase text-left">REGISTRO DE PAGO POR TRATAMIENTO INTEGRAL ODONTOLÓGICO</h5>
                                                                        <p className="text-[10px] text-teal-700 mt-1 font-medium italic text-left">Gestiona los pagos y el control del tratamiento integral del paciente.</p>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <table className="w-full text-xs text-left border-collapse">
                                                                        <thead>
                                                                            <tr className="bg-slate-100 border-b border-slate-200 text-slate-700 font-black uppercase text-[10px]">
                                                                                ...
                                                                                <th className="p-3 w-32 border-r border-slate-200">FECHA</th>
                                                                                <th className="p-3 border-r border-slate-200 text-center">MES DE CONTROL / TRATAMIENTO</th>
                                                                                <th className="p-3 w-32 border-r border-slate-200 text-center">VALOR $</th>
                                                                        ...
                                                                        <tbody className="divide-y divide-slate-100">
                                                                            {planFields.map((field, index) => (
                                                                                <tr key={field.id} className="hover:bg-slate-50/50 transition-colors">
                                                                                    <td className="p-3 text-center border-r border-slate-200 bg-slate-50/30 font-bold text-slate-500">{index + 1}</td>
                                                                                    <td className="p-2 border-r border-slate-200">
                                                                                        <input
                                                                                            type="date"
                                                                                            {...register(`plan_tratamiento.${index}.fecha`)}
                                                                                            className="w-full text-[10px] p-2 bg-slate-50 border border-slate-200 rounded uppercase font-bold text-slate-700 focus:ring-2 focus:ring-teal-500 outline-none"
                                                                                        />
                                                                                    </td>
                                                                                    <td className="p-2 border-r border-slate-200">
                                                                                        <textarea
                                                                                            {...register(`plan_tratamiento.${index}.mes_control`)}
                                                                                            rows={1}
                                                                                            className="w-full text-[10px] p-2 bg-slate-50 border border-slate-200 rounded font-bold text-slate-700 focus:ring-2 focus:ring-teal-500 outline-none text-center"
                                                                                    ...
                                                                                    <td className="p-2 border-r border-slate-200">
                                                                                        <input
                                                                                            type="number"
                                                                                            step="0.01"
                                                                                            {...register(`plan_tratamiento.${index}.valor`)}
                                                                                            className="w-full text-[10px] p-2 bg-slate-50 border border-slate-200 rounded font-bold text-slate-700 focus:ring-2 focus:ring-teal-500 outline-none text-center"
                                                                                        />
                                                                                    </td>
                                                                            ...
                                                                            <tr className="bg-teal-50/50 font-black text-teal-900 border-t-2 border-teal-100">
                                                                                <td colSpan={3} className="p-3 text-right uppercase tracking-widest text-xs pr-6">TOTAL CANCELADO</td>
                                                                                <td className="p-3 text-center text-sm border-x border-teal-200 bg-teal-100">
                                                                                    <div className="flex items-center justify-center gap-1">
                                                                                        <span className="text-teal-600">$</span>
                                                                                        {watch('plan_tratamiento_total')?.toFixed(2)}
                                                                                    </div>
                                                                                </td>
                                                                                <td></td>
                                                                            </tr>
                                                                ...
                                                                <button
                                                                    type="button"
                                                                    onClick={() => appendPlan({ fecha: new Date().toISOString().split('T')[0], mes_control: '', valor: 0, firma: '' })}
                                                                    className="flex items-center gap-2 px-6 py-2.5 bg-slate-800 text-white rounded-xl font-bold hover:bg-black transition-all active:scale-95 shadow-lg shadow-slate-200 uppercase text-[10px] tracking-widest mx-auto"
                                                                >
                                            ...
                                            <div className="w-full h-full bg-slate-800 rounded-xl shadow-inner flex flex-col overflow-hidden relative">
                                                ...
                                                <div className="flex-1 min-h-0 bg-white">
                                                    <PDFViewer width="100%" height="100%" showToolbar={false} className="border-none">
                                                        {mainAccordion === 2 ? (
                                                            <TratamientoIntegralDocument data={pdfData} />
                                                        ) : (
                                                            <FichaOdontologiaDocument data={pdfData} />
                                                        )}
                                                    </PDFViewer>
                                                </div>
                                ...
                                <div className="px-6 py-4 bg-white border-t border-slate-200 flex flex-wrap gap-4 justify-end shrink-0 shadow-upper z-10">
                                    ...
                                    {step === 2 && (
                                        <PDFDownloadLink
                                            document={mainAccordion === 2 ? <TratamientoIntegralDocument data={pdfData} /> : <FichaOdontologiaDocument data={pdfData} />}
                                            fileName={mainAccordion === 2 ? `tratamiento-integral-${formData.nombre || 'paciente'}.pdf` : `ficha-odontologia-${formData.nombre || 'paciente'}.pdf`}
