...
import Especialidades from '@/components/Services'
            ...
            <section className="py-20 lg:py-32 bg-gray-50 overflow-hidden">
                <div className="container-custom">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-5xl font-light text-secondary uppercase tracking-tight mb-4">
                            Disponibilidad en <span className="text-primary font-medium">Tiempo Real</span>
                        </h2>
