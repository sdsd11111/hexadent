...
export async function bookAppointment(details) {
    ...
    try {
        ...
        const [result] = await db.execute(
            'INSERT INTO appointments (patient_name, patient_phone, patient_cedula, appointment_date, appointment_time, duration_minutes) VALUES (?, ?, ?, ?, ?, ?)',
            [name, phone, cedula, date, time, duration]
        );
