...
export async function processChatbotMessage(phoneNumber, messageText, clinicNumber = null) {
    ...
    try {
        ...
        IMPORTANTE: SIEMPRE QUE CONFIRMES UNA CITA, DEBES INCLUIR EL BLOQUE [METADATA: ...] AL FINAL.
        SI NO INCLUYES EL METADATA, LA CITA NO SE GUARDARÁ EN EL CALENDARIO DE LA DOCTORA.
