...
export async function processChatbotMessage(phoneNumber, messageData, clinicNumber = null) {
    ...
    try {
            ...
            if (hasActiveMotive && targetDate) {
                try {
                    ...
                    if (isBlockedRows.length > 0) {
                        ...
                        availabilityContext = `⚠️ NO HAY CUPOS DISPONIBLES para ${dayName} ${targetDate} debido a nuestra política de anticipación. Ofrezca amablemente el día siguiente u otro horario.`;
                    }
        ...
        const systemPrompt = `
            ...
            MUESTRA TODOS LOS HORARIOS: No los resumas. Si el sistema te da 20 horarios, muestra los 20 organizados (mañana/tarde).
