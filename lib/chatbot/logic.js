...
export async function processChatbotMessage(phoneNumber, messageText, clinicNumber = null) {
    ...
    try {
        ...
        const resolveDate = (text) => {
            ...
            // 2. Relative logic (hoy, mañana, días de la semana)
        ...
        const getReferenceCalendar = () => {
            ...
            for (let i = 0; i < 24; i++) {
                ...
                // Use a proper formatter to get the day name correctly for that exact date
...
${getReferenceCalendar()}
        ...
        3. Si hay una advertencia (timeWarning), NO digas "Perfecto". Di: "Lo siento, ese horario no es válido..." y explica por qué.
        4. FECHAS: Rechaza fechas pasadas o inexistentes (Feb 29 en 2026/2027).
        5. Al confirmar, menciona la fecha EXACTA (día y número) del availabilityContext.
