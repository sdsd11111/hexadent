...
export async function processChatbotMessage(phoneNumber, messageData, clinicNumber = null) {
    ...
    try {
        ...
        if (isExplicitBooking || isCurrentlyInBookingFlow) {
            ...
            let duration = isPediatric ? 60 : (isOrtho || isProsthesis ? 45 : 20);
            ...
            const hasActiveMotive = isOrtho || isPediatric || isProsthesis || lowerMsg.includes('caries') || lowerMsg.includes('limpieza') || session.current_flow.includes('Motivo recibido');
