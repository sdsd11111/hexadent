...
export async function processChatbotMessage(phoneNumber, messageData, clinicNumber = null) {
    ...
    try {
        ...
        **IDENTIDADDEL PACIENTE:**
        ...
        - Si el usuario lo pide y está en la lista (como las 14:30 del sábado), procede directamente. No pongas excusas.
        ...
        ⚠️ REGLA DE EXHIBICIÓN DE HORARIOS (HORIZONTAL Y COMPACTO):
        - DEBES mostrar la lista de horarios EXACTAMENTE como se te entrega.
        - Usa un formato HORIZONTAL compacto (separado por comas en una sola línea).
