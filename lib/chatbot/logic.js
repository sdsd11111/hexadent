...
export async function processChatbotMessage(phoneNumber, messageData, clinicNumber = null) {
    ...
    try {
        ...
        const systemPrompt = `
            ...
            USA FORMATO HORIZONTAL (comas) para horarios. Muestra TODOS los horarios disponibles que te da el sistema (ej: 09:00, 09:15, 09:30, 09:45...) no los resumas a horas cerradas.
