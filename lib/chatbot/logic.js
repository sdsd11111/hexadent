...
export async function processChatbotMessage(phoneNumber, messageData, clinicNumber = null) {
    ...
    try {
        ...
        const systemPrompt = `
            ...
            PROHIBIDO RESUMIR: MUESTRA TODOS LOS HORARIOS cada 15 minutos exactos como aparecen en la lista (ej: 09:00, 09:15, 09:30, 09:45, 10:00, 10:15...). NO digas solo "a las 09:00, 10:00" ni "cada 15 minutos". Debes escribir la lista completa separada por comas para que el paciente elija el que más le convenga. Es vital que el paciente vea todas las opciones.
