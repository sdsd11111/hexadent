...
export async function processChatbotMessage(phoneNumber, messageText, clinicNumber = null) {
    ...
    try {
        ...
        if (lowerMsg.includes('cita') || lowerMsg.includes('disponibilidad') || lowerMsg.includes('cuándo') || lowerMsg.includes('horario') || lowerMsg.includes('cuanto') || lowerMsg.includes('hay') || lowerMsg.includes('se puede') || lowerMsg.includes('tienes espacio') || lowerMsg.includes('puedo ir')) {
            ...
            - ${sessionInfo}
            - Si el horario que pide el usuario (ej: 12:30 o 17:30) está en la LISTA de arriba, ACÉPTALO. No inventes que está cerrado.
            - AMBIGÜEDAD: Si el usuario dice "12:30" sin decir AM o PM, y esa hora es ambigua o ya pasó hoy, PREGÚNTALE: "¿Te refieres a las 12:30 PM (mediodía) o buscabas otro horario?".
            - Si la LISTA de arriba dice "(No hay turnos disponibles...)", explica que para ESA fecha ya no hay espacio o ya pasó la hora, y sugiere otro día. No asumas que la clínica abre tarde si simplemente el turno de la mañana ya pasó o está lleno.
            - NUNCA ofrezcas las ${morningLimit}:00 o ${afternoonLimit}:00 como opción de inicio.${timeWarning}`;
