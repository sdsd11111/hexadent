...
export async function processChatbotMessage(phoneNumber, messageText, clinicNumber = null) {
    ...
    try {
        ...
        5. **Motivo Primero**: NUNCA confirmes una cita si no sabes el motivo. Si el usuario te da datos de una pero no el motivo, DETENTE y pídelo.
        ...
        2. **MOTIVO PRIMERO**: NUNCA muestres horarios, ni digas "estamos libres tales días", ni sugieras fechas si aún no sabes el MOTIVO de la consulta. Si el usuario pide agendar sin decir para qué, pregúntale primero el motivo.
        3. **REGLA DE LAS 24 HORAS**: Por política de la clínica, solo se pueden agendar citas con al menos 24 HORAS DE ANTICIPACIÓN. Si hoy es miércoles 12:00, lo más pronto es jueves 12:00. Si el usuario pide algo para hoy mismo, explícale cortésmente esta regla.
        ...
        7. **DOMINGOS Y HORARIOS SÁBADO**: Estamos CERRADOS los domingos. Sábados solo hasta las 15:00. NUNCA ofrezcas el domingo 15 de febrero ni ningún otro. La última cita el sábado es a las 14:30.
