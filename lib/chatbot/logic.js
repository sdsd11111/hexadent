...
export async function processChatbotMessage(phoneNumber, messageText, clinicNumber = null) {
    ...
    try {
        ...
        if (lowerMsg.includes('cita') || lowerMsg.includes('disponibilidad') || lowerMsg.includes('cuándo') || lowerMsg.includes('horario') || lowerMsg.includes('cuanto') || lowerMsg.includes('hay') || lowerMsg.includes('se puede') || lowerMsg.includes('tienes espacio') || lowerMsg.includes('puedo ir')) {
            ...
            ⚠️ REGLA CRÍTICA PARA EL ASISTENTE: El ${targetDate} es ${dayNameEcu.toUpperCase()}. 
            - El horario de atención termina a las ${limitHour}:00. 
            - Como el tratamiento dura ${duration} min, la ÚLTIMA cita posible debe empezar a las ${lastTimeStr}. 
            - NUNCA ofrezcas las ${limitHour}:00 como hora de inicio.
            - Si el usuario pide un horario que NO está en la LISTA de arriba, di que NO está disponible.${timeWarning}`;
...
${getReferenceCalendar()}
        ...
        5. ÚLTIMA CITA: La clínica cierra a las 18:00 (L-V) o 15:00 (Sáb). Una cita de 20 min NO puede empezar a las 18:00 porque terminaría a las 18:20. La última debe ser 17:40. NUNCA ofrezcas la hora de cierre como hora de inicio.
