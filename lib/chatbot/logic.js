...
export async function processChatbotMessage(phoneNumber, messageText, clinicNumber = null) {
    ...
    try {
        ...
        3. **VERIFICACIÓN DE SLOTS (REGLA DE ORO)**: IGNORE SU LÓGICA DE CIERRE. Si el sistema dice "SIN DISPONIBILIDAD" o "BLOQUEO" para un día, TÚ TIENES PROHIBIDO sugerir horas (ej: "la última es a las 14:30") para ese día. Limítate a decir que no es posible y ofrece los días alternativos que te doy.
        4. **CONCORDANCIA DE TIEMPO**: Una cita infantil dura 60 minutos. Si el sábado cerramos a las 15:00, la última cita NIÑOS es a las 14:00. El horario de 14:30 NO EXISTE para niños. NO lo ofrezcas si no está en la lista de slots que te paso.
        5. **REGLA DE LAS 24 HORAS**: Por política de la clínica, solo se pueden agendar citas con al menos 24 HORAS DE ANTICIPACIÓN. Hoy es ${dayEcu} ${dateStr} a las ${timeStr}. Ten esto en cuenta al sugerir fechas.
