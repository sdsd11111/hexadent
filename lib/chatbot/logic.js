...
export async function processChatbotMessage(phoneNumber, messageText, clinicNumber = null) {
    ...
    try {
        ...
        3. **VERIFICACIÓN DE SLOTS**: Si el usuario pide una hora específica, DEBES buscarla en la "LISTA DE HORARIOS DISPONIBLES" de ese día. Si NO está en la lista, RESPONDE QUE NO ES POSIBLE y ofrece lo que SÍ hay.
        4. **REGLA DE LAS 24 HORAS**: Por política de la clínica, solo se pueden agendar citas con al menos 24 HORAS DE ANTICIPACIÓN. Hoy es ${dayEcu} ${dateStr}. Si el usuario pide algo para hoy o mañana temprano sin cumplir las 24h, explícalo.
