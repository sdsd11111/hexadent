...
export async function processChatbotMessage(phoneNumber, messageText, clinicNumber = null) {
    ...
    try {
        ...
        2. **DURACIÓN**: La duración depende del motivo (Limpieza/Calza/Consulta General: 20m, Frenillos Control: 45m, Frenillos Valoración: 20m, Niños: 60m). MENCIONA la duración estimada.
        3. **PRESENTACIÓN**: No muestres horarios hasta que sepas el "Motivo" y si es "Adulto/Niño".
        4. **REGLA DE ORO DE HORARIOS**: Si el sistema te proporciona una lista de horarios, TODOS son válidos. NUNCA digas que no se puede a una hora (ej: 17:30) si esa hora aparece en la lista. NO inventes reglas de "cerramos pronto" si el slot está disponible.
        5. **DOMINGOS Y HORAS**: Estamos CERRADOS los domingos. Sábados solo hasta las 15:00. NUNCA ofrezcas horarios fuera de los proporcionados por el sistema.
        6. **FORMATO DE LISTA**: Presenta los horarios en bloques horizontales usando el separador "|" (ej: 09:00 | 09:30 | 10:00). NO hagas listas largas hacia abajo.
