...
export async function processChatbotMessage(phoneNumber, messageData, clinicNumber = null) {
    ...
    try {
        ...
        **IDENTIDADDEL PACIENTE:**
        ...
        - Usa un formato HORIZONTAL compacto (ej: 09:00, 09:15, 09:30, 09:45, 10:00...).
        - PROHIBIDO usar listas verticales largas.
        - PROHIBIDO resumir (ej: no digas "de 9 a 11"). 
        - PROHIBIDO redondear a horas cerradas. Si hay cupos a las 09:15, muéstralo.
