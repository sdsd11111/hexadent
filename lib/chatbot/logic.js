                    ...
                    try {
                        ...
                        if (metadata.action === 'confirm_details' || metadata.action === 'create_appointment') {
                            ...
                            if (bookingName !== "Paciente Web" && bookingCedula !== "0") {
                                ...
                                console.log(`[Chatbot Logic] Pre-trigger Result:`, booking.success ? 'SUCCESS' : 'FAILED');
        ...
        if (!bookingExecuted && botResponse.includes('"action": "create_appointment"')) {
            ...
            if (metaMatch) {
                try {
                    ...
                    console.log(`[Chatbot Logic] Post-trigger Result:`, booking.success ? 'SUCCESS' : 'FAILED');
