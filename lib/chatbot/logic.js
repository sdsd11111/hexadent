...
export async function processChatbotMessage(phoneNumber, messageText, clinicNumber = null) {
    ...
    try {
        ...
        4. **FORMATO DE FECHA**: En el mensaje final de confirmación, NUNCA digas "Mañana" o "Pasado Mañana". Di SIEMPRE la fecha exacta (ej: "11 de febrero").
        5. **METADATA**: El campo "time" de METADATA debe estar SIEMPRE en formato 24h (HH:MM), ej: "15:30", NUNCA "3:30 PM".
        6. Al tener todo, AGENDA Y CONFIRMA usando el bloque [METADATA: ...] al final.
